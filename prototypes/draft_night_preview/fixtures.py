...
def live_fixture() -> LiveFixture:
    ...
    return LiveFixture(
        ...
        available_players=(
            ...
            AvailablePlayer(45, "Evan Brooks", "RB", "RB16", "CHI", 11, 4, 193.2, 11.8, 59.4, 55.0, "GOOD VALUE"),
            AvailablePlayer(48, "Liam Carter", "WR", "WR18", "MIA", 9, 5, 187.6, 9.7, 56.2, 52.0, "CONSIDER"),
            AvailablePlayer(52, "Owen Price", "QB", "QB11", "ARI", 8, 5, 298.3, 8.9, 54.7, 50.0, "WAIT"),
            AvailablePlayer(55, "Mason Reid", "TE", "TE6", "GB", 6, 5, 162.5, 7.1, 51.6, 47.0, "SAFE TO WAIT"),
            AvailablePlayer(59, "Cole Turner", "RB", "RB20", "NYJ", 10, 6, 181.4, 5.6, 48.8, 43.0, "CONSIDER"),
            AvailablePlayer(63, "Nate Howell", "WR", "WR22", "SF", 14, 6, 176.8, 4.8, 46.1, 41.0, "WAIT"),
            AvailablePlayer(67, "Eli Mason", "TE", "TE8", "KC", 10, 6, 154.3, 3.9, 43.9, 38.0, "SAFE TO WAIT"),
            AvailablePlayer(71, "Grant Lewis", "RB", "RB24", "IND", 11, 7, 169.7, 2.7, 40.5, 35.0, "CONSIDER"),
        ),
        roster=(
